...
documcp:
  ...
  validated_against_commit: 210a274
---
...
- `cleanupAgentArtifacts`: Detect, classify, and clean up artifacts generated by AI coding agents (Phase 3)
...
- Commit: 210a274 - feat: Add agent artifact detection and cleanup tool (#80)
- GitHub Issue: #80 - Agent artifact detection and cleanup tool
