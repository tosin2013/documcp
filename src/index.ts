...
// v0.6.0 deprecation: DOCUMCP_LLM_* env vars are no longer used.
// They will be removed entirely in v0.7.0. See ADR-014.
const LLM_DEPRECATED_VARS = [
  "DOCUMCP_LLM_PROVIDER",
  "DOCUMCP_LLM_API_KEY",
  "DOCUMCP_LLM_MODEL",
  "DOCUMCP_LLM_BASE_URL",
];
for (const envVar of LLM_DEPRECATED_VARS) {
